<?php $title = '13-0297-WC-Will-Rogers-Home'; ?>
  ...
  <div class="think-us">
    <div class="outer-th">
      <div class="think-wrapper">
        <h2>Think of us</h2>
        <p>
          Will Rogers Theatre provides a unique and classic environment for any occasion. With a beautiful interior and unique ambience.
          Will Rogers Theatre Events Center serves as a full time location for weddings, banquets and receptions.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="col col-2">
      <div class="col-item">
        ...
        <div class="col-wrapper">
          <div class="col-event">
            <h4>Sushi Class</h4>
            <span>Sunday, June 23, 2013 • 2 – 4pm</span>

            <p>Learn to roll your own sushi! Seating is limited. To reserve your spot or for more info, call 528-8862.</p>
          </div>
          <div class="col-event">
            <h4>Mondays For A Change</h4>
            <span>Monday, July 1, 2013</span>

            <p>Sushi Neko will be helping the Red Cross raise funds for disaster relief by donating 10% of our sales.</p>
          </div>
          <div class="col-event">
            <h4>Sushi Neko’s Birthday!</h4>
            <span>Saturday, September 21, 2013</span>

            <p>Come try our new special "Sweet 16" Roll as we are celebrating Sushi Neko 16th anniversary!!</p>
          </div>
        </div>
      </div>
      <div class="btn-wrapper">
        <a class="btn" href="#">View calendar</a>
      </div>
    </div>
